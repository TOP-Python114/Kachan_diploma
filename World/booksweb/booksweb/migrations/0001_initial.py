    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isn', models.CharField(help_text='Должно содержать 13 символов', max_length=13, verbose_name='ISBN книги')),
                ('file', models.FileField(blank=True, null=True, upload_to='')),
                ('author', models.ManyToManyField(help_text='Введите автора книги', to='booksweb.author', verbose_name='Автор книги')),
                ('genre', models.ForeignKey(help_text='Введите жанр книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='booksweb.genre', verbose_name='Жанр книги')),
                ('language', models.ForeignKey(help_text='Введите язык книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='booksweb.language', verbose_name='Язык книги')),
            ],
        ),
    ]
